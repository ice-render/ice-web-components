...
import { tween, UITweenHandle, UIFrameDriver } from '../util/UIAnimation';
...
export type UICarouselFrameDriver = UIFrameDriver;

export interface UICarouselScheduler {
  setInterval(handler: () => void, ms: number): any;
  clearInterval(handle: any): void;
}

export interface UICarouselOptions {
  slides?: UIComponent[];
  left?: number;
  top?: number;
  width?: number;
  ...
  driver?: UICarouselFrameDriver;
  scheduler?: UICarouselScheduler;
}
...
const defaultScheduler: UICarouselScheduler = {
...
export class UICarousel extends UIComponent {
  ...
  private driver?: UICarouselFrameDriver;
  private scheduler: UICarouselScheduler;
  private onChangeCallback: ((index: number) => void) | null;
  private viewport: UIComponent | null = null;
  private track: UIComponent | null = null;
  private prevButton: UIComponent | null = null;
  private nextButton: UIComponent | null = null;
  private dots: UIComponent[] = [];
  private tweenHandle: UITweenHandle | null = null;
  private timer: any = null;
  private running = false;

  constructor(props: UICarouselOptions = {}) {
  ...
  public setSlides(slides: UIComponent[]): this {
  ...
  public getSlideNode(index: number): UIComponent | null {
    return this.slides[index] || null;
  }

  public getTrackNode(): UIComponent | null {
    return this.track;
  }

  public getPrevButton(): UIComponent | null {
    return this.prevButton;
  }

  public getNextButton(): UIComponent | null {
    return this.nextButton;
  }

  public getDotNode(index: number): UIComponent | null {
  ...
  private __makeArrow(text: string, left: number): UIComponent {
    const theme = uiManager.getTheme();
