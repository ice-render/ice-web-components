 ...
 */
export interface UICollapseItem {
  key: string;
  title: string;
  content?: string | (() => any);
  disabled?: boolean;
...
export interface UICollapseOptions {
...
export class UICollapse extends UIComponent {
  private items: UICollapseItem[];
  private active: string[];
  private accordion: boolean;
  private headerHeight: number;
  private contentHeight: number;
  private expandCallback: ((keys: string[]) => void) | null;
  private headerNodes = new Map<string, UIComponent>();
  private contentNodes = new Map<string, UIComponent>();
  private offsetMap = new Map<string, number>();

  constructor(props: UICollapseOptions) {
  ...
  public getHeaderNode(key: string): UIComponent | null {
    return this.headerNodes.get(key) || null;
  }

  public getContentNode(key: string): UIComponent | null {
