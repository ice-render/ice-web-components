 ...
 */
export interface UIInputNumberOptions {
  value?: number;
  min?: number;
  max?: number;
  step?: number;
...
export class UIInputNumber extends UIComponent {
  ...
  private textLabel: UILabel | null = null;
  private decreaseButton: UIButton | null = null;
  private increaseButton: UIButton | null = null;
  private buffer = '';
  private running = false;

  constructor(props: UIInputNumberOptions = {}) {
  ...
  public getIncreaseButton(): UIButton | null {
    return this.increaseButton;
  }

  public getDecreaseButton(): UIButton | null {
