...
export class UIProgressBar extends UIComponent {
  ...
  constructor(props: any = {}) {
    ...
    const type: UIProgressType = props.type === 'circle' ? 'circle' : 'line';
    ...
    if (circle) {
      ...
      this.trackRing = new UIProgressRing({
        left: 0,
        top: 0,
        width: diameter,
        height: diameter,
  ...
  public getTextNode(): UILabel | null {
