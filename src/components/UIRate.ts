 ...
 */
export interface UIRateOptions {
  count?: number;
  value?: number;
  disabled?: boolean;
  size?: number;
...
export class UIRate extends UIComponent {
  ...
  private starNodes: UIComponent[] = [];
  private onChange: ((value: number) => void) | null;
  private running = false;

  constructor(props: UIRateOptions = {}) {
  ...
  public getStarNodes(): UIComponent[] {
