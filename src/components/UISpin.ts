...
class UISpinArc extends ICEPath {
 ...
 */
export interface UISpinOptions {
  size?: number;
  spinning?: boolean;
  tip?: string;
  color?: string;
...
export class UISpin extends UIComponent {
  private arc: UISpinArc;
  private spinning: boolean;

  constructor(props: UISpinOptions = {}) {
