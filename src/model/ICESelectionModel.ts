...
export type ICESelectionMode = 'single' | 'multiple';
...
export type ICESelectionListener = (model: ICESelectionModel) => void;

export class ICESelectionModel {
  private mode: ICESelectionMode;
  private selected: string[];
  private listeners = new Set<ICESelectionListener>();
  ...
  public getMode(): ICESelectionMode {
    return this.mode;
  }

  public setMode(mode: ICESelectionMode): this {
    if (mode === this.mode) {
      return this;
    }
    this.mode = mode;
  ...
  public addChangeListener(listener: ICESelectionListener): () => void {
