...
export function getUIWorldBox(component: any): UIWorldBox {
  let left = 0;
  let top = 0;
  let node = component;
...
export function isPointInsideUIBox(box: UIWorldBox, x: number, y: number): boolean {
