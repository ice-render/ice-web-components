...
describe('ICEComment', () => {
  ...
  it('无操作/无时间时高度更小', () => {
    const small = new ICEComment({ width: 300, author: 'A', content: '正文' });
    const big = new ICEComment({ width: 300, author: 'A', content: '正文', time: '刚刚', actions: [{ key: 'x', text: '操作' }] });
